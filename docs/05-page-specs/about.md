...
1. **We're not new** - 8 years in Singapore since 2017
2. **We have real R&D** - Not just integrators, we build technology
3. **We're part of the ecosystem** - Government partners, industry relationships
4. **We deliver at scale** - 10,000+ assets, not just pilots
...
1. **In-House Development**
   ...
   - Description: `Our hardware and software are designed and built by our team in Singapore. Full control from sensor to cloud.`
...
3. **Government Backing**
   ...
   - Description: `Awarded S$2.1M under the NRF Cities of Tomorrow programme—recognition of our innovation and potential.`
   - Logo: NRF
...
| Grant Award | S$2.1M |
| Certifications | BCA RM&D |

---

### Section 4: Ecosystem & Partnerships
...
### Section 5: Why Softgrid (4 Pillars)
...
1. **Battle-Tested Reliability**
   ...
   - Description: `Deployed on over 10,000 public assets. Trusted by HDB for Singapore's public housing.`

2. **Deep Tech Advantage**
   - Icon: Chip/AI
   - Description: `Proprietary AI and real-time digital twin engines. Not generic white-label software.`

3. **End-to-End Integrity**
   - Icon: Link/chain
   - Description: `Complete control from hardware sensors to the technician's mobile app. Seamless integration.`

4. **Regulatory Alignment**
   - Icon: Document/certificate
   - Description: `Purpose-built for BCA's Smart FM and RM&D compliance requirements.`

---

### Section 6: Global Expansion (Optional)
...
- **Website**: www.softgridsensing.com
