...
const ladder = [
  ...
  },
  {
    ...
    height: 'min-h-60',
    bg: 'bg-white border-primary-300/60',
    text: 'text-slate-700',
  ...
  },
  {
    ...
    title: 'AFOS',
    height: 'min-h-80',
    bg: 'bg-gradient-to-b from-primary-500 to-primary-700 border-primary-500 shadow-[0_20px_60px_-15px_rgba(31,153,197,0.45)]',
    text: 'text-white',
    bullets: [
    ...
    <section className="relative overflow-hidden bg-slate-50 py-20 md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div data-animate className="mb-16 text-center">
          <div className="mb-4 text-xs font-bold uppercase tracking-[3px] text-primary-600">How AFOS Works</div>
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-navy-900">
        ...
        <div className="mb-28 grid items-center gap-12 lg:grid-cols-[5fr_7fr] lg:gap-16" data-animate>
          <div>
            <div className="mb-4 text-xs font-bold uppercase tracking-[3px] text-primary-600">The Foundation</div>
            <h3 className="mb-6 text-3xl md:text-4xl font-bold leading-[1.15] tracking-tight text-navy-900">
        ...
        <div className="mb-28" data-animate>
          <div className="mb-12 max-w-3xl">
            <div className="mb-4 text-xs font-bold uppercase tracking-[3px] text-primary-600">The Engines</div>
            <h3 className="mb-6 text-3xl md:text-4xl font-bold tracking-tight text-navy-900">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
            {engines.map((engine) => (
              <div key={engine.name} className="border-l border-primary-500/30 pl-6">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary-500/10 text-primary-600 ring-1 ring-primary-500/30">
                  {engine.icon}
                </div>
                <div className="mb-1 text-xl font-bold text-navy-900">{engine.name}</div>
                <div className="mb-4 text-sm font-semibold uppercase tracking-wider text-primary-600">{engine.subtitle}</div>
        ...
        <div data-animate>
          <div className="mb-12 max-w-3xl">
            <div className="mb-4 text-xs font-bold uppercase tracking-[3px] text-primary-600">The Trajectory</div>
            <h3 className="mb-6 text-3xl md:text-4xl font-bold tracking-tight text-navy-900">
          ...
          <div className="relative pl-16 pb-20">
            ...
            <div className="hidden md:flex pointer-events-none absolute left-0 top-0 bottom-12 items-center">
              <div className="[writing-mode:vertical-rl] rotate-180 whitespace-nowrap text-[11px] font-bold uppercase tracking-[3px] text-slate-500">
                Business Value
              </div>
            </div>
            ...
            <div className="absolute left-1/2 bottom-2 -translate-x-1/2 text-[11px] font-bold uppercase tracking-[3px] text-slate-500">
              Client Journey
            </div>
          </div>
        </div>
...
function FoundationDiagram(): React.ReactElement {
  return (
    <div className="relative">
      <div className="pointer-events-none absolute -inset-4 rounded-3xl bg-cyan-500/10 opacity-70 blur-2xl" />
      <div className="relative space-y-4 rounded-2xl border border-primary-300/50 bg-white p-6 md:p-8 shadow-[0_10px_40px_-15px_rgba(15,23,42,0.15)]">
        {/* Layer 1: Solutions */}
        <div className="rounded-xl border border-slate-200 bg-slate-50 px-5 py-4">
          <div className="mb-3 text-[10px] font-bold uppercase tracking-[2px] text-slate-500">Solutions for Industries</div>
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-5">
            {solutions.map((s) => (
              <div
                key={s}
                className="flex items-center justify-center rounded-lg border border-slate-200 bg-white px-3 py-2 text-center text-xs font-semibold text-slate-700"
              >
                {s}
              </div>
            ))}
            <div className="flex items-center justify-center rounded-lg border border-dashed border-slate-300 bg-white/60 px-3 py-2 text-center text-xs font-semibold text-slate-400">
              + More
            </div>
          </div>
        </div>
        ...
        <Connectors />
        {/* Layer 2: Products */}
        <div className="rounded-xl border border-primary-300/60 bg-primary-50 px-5 py-4">
          <div className="mb-3 text-[10px] font-bold uppercase tracking-[2px] text-primary-700">Product Suites</div>
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-5">
            {products.map((p) => (
              <div
                key={p.name}
                className="flex flex-col items-center justify-center rounded-lg border border-primary-300/60 bg-white px-3 py-2 text-center"
              >
                <span className="text-sm font-bold text-navy-900">{p.name}</span>
                {p.name !== p.role && (
                  <span className="text-[10px] font-semibold uppercase tracking-wider text-primary-600">{p.role}</span>
                )}
              </div>
            ))}
            <div className="flex items-center justify-center rounded-lg border border-dashed border-primary-300/60 bg-white/60 px-3 py-2 text-center text-xs font-semibold text-primary-400">
              + More
            </div>
          </div>
        </div>
        ...
        <div className="relative rounded-xl border border-primary-500 bg-gradient-to-br from-primary-500 to-primary-700 p-5 shadow-[0_20px_60px_-15px_rgba(31,153,197,0.5)]">
          <div className="mb-3 flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase tracking-[2px] text-primary-100">AFOS Platform</span>
            <span className="inline-flex items-center gap-1 rounded-full border border-white/40 bg-white/15 px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-[2px] text-white">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            {engines.map((e) => (
              <div key={e.name} className="flex items-center gap-2 rounded-lg border border-white/25 bg-white/10 px-3 py-2">
                <span className="text-white">{e.icon}</span>
...
function DiagramLayer({
  ...
  return (
    <div className={`rounded-xl border ${styles} px-5 py-3`}>
      <div className="mb-2 text-[10px] font-bold uppercase tracking-[2px] text-slate-500">{label}</div>
